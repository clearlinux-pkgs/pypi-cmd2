...
Version  : 2.5.9
Release  : 140
URL      : https://files.pythonhosted.org/packages/da/ab/53b10acb2534c8cd450e9403b79f95245b5838f9c4fa916e873e7d9d9b8a/cmd2-2.5.9.tar.gz
Source0  : https://files.pythonhosted.org/packages/da/ab/53b10acb2534c8cd450e9403b79f95245b5838f9c4fa916e873e7d9d9b8a/cmd2-2.5.9.tar.gz
...
%prep
%setup -q -n cmd2-2.5.9
cd %{_builddir}/cmd2-2.5.9
pushd ..
cp -a cmd2-2.5.9 buildavx2
popd
...
export LANG=C.UTF-8
export SOURCE_DATE_EPOCH=1737390614

...
Source0  : https://files.pythonhosted.org/packages/13/04/b85213575a7bf31cbf1d699cc7d5500d8ca8e52cbd1f3569a753a5376d5c/cmd2-2.4.3.tar.gz
...
%prep
%setup -q -n cmd2-2.4.3
cd %{_builddir}/cmd2-2.4.3
pushd ..
cp -a cmd2-2.4.3 buildavx2
popd
...
export LANG=C.UTF-8
export SOURCE_DATE_EPOCH=1707114171
...
cp %{_builddir}/cmd2-%{version}/LICENSE %{buildroot}/usr/share/package-licenses/pypi-cmd2/73399b728f4d78e54f7c87bce9296d1f0f6d2648 || :
...
/usr/share/package-licenses/pypi-cmd2/73399b728f4d78e54f7c87bce9296d1f0f6d2648

...
Source0  : https://files.pythonhosted.org/packages/f7/2a/018fe937e25e1db0cafeb358c117644a58cdba24f5bbee69c003faf0b454/cmd2-2.5.11.tar.gz
...
%prep
%setup -q -n cmd2-2.5.11
cd %{_builddir}/cmd2-2.5.11
pushd ..
cp -a cmd2-2.5.11 buildavx2
popd
...
export LANG=C.UTF-8
export SOURCE_DATE_EPOCH=1737997051
